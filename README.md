...
**HTML Pages**
1. **inventory_system/inventory/templates/base.html**
   This is the home page where once the inventory management opened this homepage will be opened
      {% load static %}
      <!DOCTYPE html>
      <html lang="en">
      <head>
         ...
         <title>Home Page - Inventory System</title>
         <!-- Bootstrap CSS -->
         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="{% url 'add_stock_movement' %}">Add Stock</a>
                     </li>
                     <li class="nav-item">
      ...
      <header class="hero bg-primary text-white text-center py-5">
         <div class="container">
            ...
            <p class="lead">Efficient, easy, and reliable system to manage your products, suppliers, and sales orders.</p>
            <a href="{% url 'add_product' %}" class="btn btn-light btn-lg">Get Started</a>
         </div>
      </header>
                  ...
                  <div class="col-md-4 mb-4">
                     <div class="card shadow-sm">
                        <div class="card-body">
                              ...
                              <p class="card-text">Easily add and manage products in your inventory with real-time updates.</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-4 mb-4">
                     <div class="card shadow-sm">
                        <div class="card-body">
                              ...
                              <p class="card-text">Keep track of suppliers and their details for a smooth supply chain.</p>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-4 mb-4">
                     <div class="card shadow-sm">
                        <div class="card-body">
                              ...
                              <p class="card-text">Create and manage sales orders effortlessly with order history tracking.</p>
                        </div>
                     </div>
                  </div>
            </div>
...
2. **inventory_system/inventory/templates/base.html**
